        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
                httpSecurity
                                ...
                                .authorizeHttpRequests(authorize -> authorize
                                                ...
                                                .requestMatchers(GET, Api.PRODUCT + "/**")
                                                .hasAnyAuthority(ADMIN_READ.name(), PRODUCT_READ.name())
                                                .requestMatchers(POST, Api.CUSTOMER + "/**")
                                                .hasAnyAuthority(ADMIN_CREATE.name(), PRODUCT_CREATE.name())
                                                .requestMatchers(PUT, Api.CUSTOMER + "/**")
                                                .hasAnyAuthority(ADMIN_UPDATE.name(), PRODUCT_UPDATE.name())
                                                .requestMatchers(DELETE, Api.CUSTOMER + "/**")
                                                .hasAnyAuthority(ADMIN_DELETE.name(), PRODUCT_DELETE.name())
